...
Python, bash, git, LaTeX, HTML, Markdown, reStructuredText
...
\begin{innerlist}
	\item Refereed first author publications: 2, total citations: 15
	\item Refereed total publications: 5, total citations: 30
	\item H-index: 3
	%\item h-index: 
\end{innerlist}

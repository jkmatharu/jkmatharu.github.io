...
\begin{innerlist}
	\item Refereed first author publications: 2, total citations: 9
	\item Refereed total publications: 3, total citations: 16
	\item H-index: 2
	%\item h-index: 
\end{innerlist}
...
\section{Service}
Co-Chair of Central Texas James Webb Space Telescope (JWST) Workshops Comittee \hfill {Nov 2019 -- Feb 2020}
\begin{innerlist}

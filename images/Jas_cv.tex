...
\begin{innerlist}
	\item Refereed first author publications: 2, total citations: 16
	\item Refereed total publications: 5, total citations: 32
	\item H-index: 3
	%\item h-index: 
\end{innerlist}
